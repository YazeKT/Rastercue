...
module.exports = {
  ...
  daisyui: {
    ...
    themes: [
      {
        rastercue: {
          primary: '#A5A0FF', 'primary-content': '#14161B',
          secondary: '#353941', 'secondary-content': '#F1F2F6',
          accent: '#A5A0FF', 'accent-content': '#14161B',
          neutral: '#22252D', 'neutral-content': '#F1F2F6',
          'base-100': '#22252D', 'base-200': '#1B1E24', 'base-300': '#14161B',
          'base-content': '#F1F2F6', info: '#75D5E8', success: '#87D5AD', warning: '#EBC27D', error: '#FF979F',
          '--rounded-btn': '0.45rem', '--rounded-badge': '0.35rem', '--animation-btn': '0s', '--animation-input': '0.15s', '--btn-text-case': 'none', '--btn-focus-scale': '1', '--border-btn': '1px', '--tab-radius': '0.4rem',
        },
        upscayl: {
          primary: "#334155",
          secondary: "#4f46e5",
