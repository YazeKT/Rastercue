...
const MainContent = ({
  ...
  return (
    ...
    >
      <div className="rastercue-preview">
      ...
      <MoreOptionsDrawer zoomAmount={zoomAmount} setZoomAmount={setZoomAmount} resetImagePaths={resetImagePaths}/>
    </div>
  );
};
