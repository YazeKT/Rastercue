...
export function SupportPanel({ onReplayGuide }: { onReplayGuide: () => void }) {
  ...
  return <div className="grid gap-5 md:grid-cols-2">
    ...
    <section className="space-y-4 rounded-lg border border-base-content/15 bg-base-200 p-5">
      ...
      <p className="text-xs opacity-75">For troubleshooting, include your version, model, image dimensions and relevant log entries. Do not share confidential client images or private file paths.</p>
    </section>
  </div>;
}
